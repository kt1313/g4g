...
public class MatchService {
    ...
    @Autowired
    public MatchService(ClubRepository clubRepository,
                        PlayerRepository playerRepository) {
        this.clubRepository = clubRepository;
        this.playerRepository = playerRepository;
    }
// zamiast etgo ponizej moze w ClubService?
//    public void creatMatchTeams(Club hostClub, Club guestClub) {
//        List<Player> hostMatchTeam = this.playerRepository.findAllByPlayerClubAndFirstSquadPlayer(hostClub);
//        List<Player> guestMatchTeam = this.playerRepository.findAllByPlayerClubAndFirstSquadPlayer(hostClub);
